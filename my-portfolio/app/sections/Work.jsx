...
export function Work() {
    return (
        <motion.main variants={textVariants} initial="initial" whileInView={"animate"} className="flex flex-col items-center backdrop-blur-md w-full rounded-lg mx-auto py-10 gap-5">
            <motion.section className="flex flex-col gap-3">
                <motion.h1 className="text-3xl font-extrabold sm:text-5xl md:text-8xl text-center text-success">Lets work together</motion.h1>
            ...
            <section className="flex flex-col sm:flex-row gap-2">
                <motion.div className="flex flex-col gap-1 justify-center items-center py-5 px-7 bg-secondary-400 rounded-xl text-white hover:bg-secondary-500">
